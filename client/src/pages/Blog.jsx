  ...
  return data ? (
    <div className='relative'>
      ...
      <div
        ...
        border-primary/35 bg-primary/5 font-medium text-primary'>Midenga</p>
      </div>
      ...
      <div className='mt-14 mb-10 max-w-3xl mx-auto'>
        <p
          className='font-semibold mb-4'>Comments({comments.length})</p>
        <div className='flex flex-col gap-4'>
          {comments.map((item, index) => (
            <div key={index}
              ...
              <p
                className='text-sm max-w-md ml-8'>{item.content}</p>
              <div
      ...
      <div className='max-w-3xl mx-auto'>
        <p
          className='font-semibold mb-4'>Add your Comment</p>
        <form onSubmit={addComment}
          className='flex flex-col items-start gap-4 max-w-lg'>
          <input onChange={(e) => setName(e.target.value)} value={name} type="text" placeholder='Name' required
            className='w-full p-2 border order-gray-300 rounded outline-none' />
