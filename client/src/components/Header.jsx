  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
       <div className='text-center mt-20 mb-8'>
            ...
            text-gray-700'
            >Number One <span className='text-primary'>Blogging </span><br/> Platform.</h1>
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500' >
                This is a blog platform where you can share your thoughts, ideas, and stories with the world.
                Whether you're a seasoned writer or just starting out, our platform provides the tools and community you need to succeed.
            </p>
